...
public struct MockUserReposRepository: UserReposRepositoryProtocol {
    ...
    public static var newRepo: MockUserReposRepository {
        MockUserReposRepository()
    }
}
